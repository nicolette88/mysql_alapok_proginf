...
-- vagy a use statementet használjuk, vagy minden alkalommal explicit megadjuk az adatbázis nevét...
use ecommerce;
...
-- minden bejegyzést lekérdezünk a rates táblában
...
select * from ecommerce.users
where first_name = 'Hegedűs-Németh';
